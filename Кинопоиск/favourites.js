function load() {
  ...
  if (Array.isArray(objects)) {
    let starObjects = objects.filter((obj) => obj.star === true);
    starObjects.forEach((obj) => {
      ...
      div.innerHTML = `
        <div class="cart" data-id="${obj.id}" style="padding-inline: 10px;"> 
          ...
          <button class="star-btn" style="width: 30px; height: 30px;">
            <img class="star" style="width: 30px; height: 30px;" src="/img/gold_star.svg" alt="star">
          </button>
        </div>
      `;
